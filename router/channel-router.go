...
func registerChannelRoutes(apiRouter *gin.RouterGroup) {
	...
	channelRoute.POST("/:id/codex/auth-json/export",
		middleware.RootAuth(),
		middleware.CriticalRateLimit(),
		middleware.DisableCache(),
		middleware.SecureVerificationRequired(),
		controller.ExportCodexAuthJSON,
	)
...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/codex/auth-json/normalize", permission: authz.ChannelSensitiveWrite, handler: controller.NormalizeCodexAuthJSON},
